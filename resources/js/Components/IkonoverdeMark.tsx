...
/**
 * Ikonoverde brand mark — the sprout glyph.
 *
 * Renders with `fill="currentColor"` so the color is controlled by the
 * surrounding text color (typically `text-[var(--iko-verde)]`). This
 * keeps the Verde-In-Wordmark Rule honest: green appears only where
 * the mark or the literal "verde" of the wordmark is rendered.
 */
export default function IkonoverdeMark(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
