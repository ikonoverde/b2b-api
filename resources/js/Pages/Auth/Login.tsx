...
export default function Login({ postUrl = '/login', registerUrl = '/register' }: LoginProps) {
    ...
    const { flash, errors: pageErrors } = usePage() as {
        props: {
    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                ...
                {pageErrors?.google && (
                    <FlashBanner kind="error" message={pageErrors.google} />
                )}
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex items-center justify-between">
                        <label className="flex items-center gap-2.5 cursor-pointer">
                            ...
                            />
                            <span className="text-[14px] text-[var(--iko-stone-ink)]">Recordarme</span>
                        </label>
                        <Link
        ...
        <div
            className={`border px-4 py-3 text-[13px] leading-relaxed ${
                kind === 'success'
                    ...
                    : 'border-[var(--iko-error)] bg-[var(--iko-error)]/5 text-[var(--iko-error)]'
            }`}
        >
            {message}
        </div>
