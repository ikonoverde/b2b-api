...
#[Name('Blog Server')]
#[Version('1.0.0')]
#[Instructions('Manage blog content for the public storefront. Use list-blog-posts to see what already exists and find slugs, get-blog-post to retrieve full post details by ID or slug, create-blog-post to create draft, scheduled, or published posts, and edit-blog-post to update existing posts or set their cover images. Cover images must already exist on the public storage disk.')]
