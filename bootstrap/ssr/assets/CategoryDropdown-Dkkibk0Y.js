...
function CategoryDropdown({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col gap-2 relative", children: [
    /* @__PURE__ */ jsx("label", { className: "text-sm font-medium text-foreground", children: "Categoría" }),
    /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsx("span", { className: categoryId ? "text-foreground" : "text-muted-foreground", children: selectedCategory?.name || "Seleccionar categoría" }),
          /* @__PURE__ */ jsx(ChevronDown, { className: "w-[18px] h-[18px] text-muted-foreground" })
        ]
      }
    ),
    isOpen && /* @__PURE__ */ jsx("div", { className: "absolute top-full left-0 right-0 mt-1 bg-card rounded-lg border border-border shadow-lg z-10 max-h-48 overflow-y-auto", children: categories.map((cat) => /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
