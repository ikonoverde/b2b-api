  ...
  return /* @__PURE__ */ jsx(AppLayout, { title: "Productos Destacados", active: "featured-products", children: /* @__PURE__ */ jsx("div", { className: "p-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-8", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-foreground", children: "Productos Destacados" }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Administra los productos destacados en la página principal" })
      ] }),
      /* @__PURE__ */ jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsx("div", { className: "bg-card rounded-xl border border-border divide-y divide-border", children: manager.products.length === 0 ? /* @__PURE__ */ jsx("div", { className: "p-8 text-center", children: /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm", children: "No hay productos destacados. Usa la búsqueda para agregar productos." }) }) : manager.products.map((product, index) => /* @__PURE__ */ jsx(
      FeaturedProductItem,
      {
        product,
        index,
    ...
    /* @__PURE__ */ jsx("p", { className: "mt-3 text-xs text-muted-foreground", children: "Máximo 20 productos. Arrastra para reordenar." })
  ] }) }) });
}
function ProductSearchDropdown({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mb-6 relative", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 bg-card border border-border rounded-lg px-4 py-3", children: [
    ...
    showDropdown && search && filteredAvailable.length > 0 && /* @__PURE__ */ jsx("div", { className: "absolute z-10 top-full mt-1 w-full bg-card border border-border rounded-lg shadow-lg max-h-60 overflow-y-auto", children: filteredAvailable.slice(0, 10).map((product) => /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("span", { className: "text-sm text-foreground", children: product.name }),
            /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground ml-2", children: product.sku })
          ] }),
...
function FeaturedProductItem({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 px-4 py-3", children: [
    /* @__PURE__ */ jsx("span", { className: "w-6 text-center text-sm font-medium text-muted-foreground", children: index + 1 }),
    /* @__PURE__ */ jsx("div", { className: "w-10 h-10 bg-muted rounded-lg overflow-hidden shrink-0", children: product.image_url ? /* @__PURE__ */ jsx("img", { src: product.image_url, alt: product.name, className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsx("div", { className: "w-full h-full flex items-center justify-center", children: /* @__PURE__ */ jsx("div", { className: "w-5 h-5 bg-border rounded-full" }) }) }),
    /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
      /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-foreground truncate", children: product.name }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
      /* @__PURE__ */ jsx("button", { onClick: onMoveUp, disabled: index === 0, className: "p-1.5 rounded hover:bg-muted disabled:opacity-30 cursor-pointer", children: /* @__PURE__ */ jsx(ArrowUp, { className: "w-4 h-4 text-muted-foreground" }) }),
      /* @__PURE__ */ jsx("button", { onClick: onMoveDown, disabled: index === total - 1, className: "p-1.5 rounded hover:bg-muted disabled:opacity-30 cursor-pointer", children: /* @__PURE__ */ jsx(ArrowDown, { className: "w-4 h-4 text-muted-foreground" }) }),
      /* @__PURE__ */ jsx("button", { onClick: onRemove, className: "p-1.5 rounded hover:bg-destructive/10 cursor-pointer", children: /* @__PURE__ */ jsx(X, { className: "w-4 h-4 text-destructive" }) })
    ] })
  ] });
}
export {
