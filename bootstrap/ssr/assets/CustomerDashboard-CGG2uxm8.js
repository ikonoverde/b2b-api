...
const PURCHASE_FACTS = ["Precios visibles", "Una unidad", "Pago claro"];
function PurchaseFacts() {
  return /* @__PURE__ */ jsx("ul", { className: "mt-3 flex flex-wrap gap-2", children: PURCHASE_FACTS.map((fact) => /* @__PURE__ */ jsx(
    "li",
    {
