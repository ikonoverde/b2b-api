...
function getSortIcon(field) {
  ...
  if (currentSortBy !== field) {
    return /* @__PURE__ */ jsx(ArrowUpDown, { className: "w-4 h-4 text-muted-foreground" });
  }
  return currentSortOrder === "asc" ? /* @__PURE__ */ jsx(ArrowUpDown, { className: "w-4 h-4 text-foreground" }) : /* @__PURE__ */ jsx(ArrowUpDown, { className: "w-4 h-4 text-foreground rotate-180" });
}
  ...
  return /* @__PURE__ */ jsxs(
    "tr",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsx("span", { className: "text-sm text-foreground", children: user.email }) }),
        /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsx("span", { className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-muted text-foreground", children: roleLabels[user.role] || user.role }) }),
        /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsx("span", { className: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${user.is_active ? "bg-primary/10 text-primary" : "bg-destructive/10 text-destructive"}`, children: user.is_active ? "Activo" : "Inactivo" }) }),
        /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsx("span", { className: "text-sm text-muted-foreground", children: formatDate(user.created_at) }) })
      ]
    }
  );
}
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsx(
        Link,
        {
          ...
          className: `p-2 rounded-lg border border-border ${users.current_page === 1 ? "opacity-50 cursor-not-allowed pointer-events-none" : "hover:bg-muted"}`,
          preserveScroll: true,
      ...
      /* @__PURE__ */ jsx(
        ...
        {
          href: `?page=${users.current_page + 1}`,
          className: `p-2 rounded-lg border border-border ${users.current_page === users.last_page ? "opacity-50 cursor-not-allowed pointer-events-none" : "hover:bg-muted"}`,
          preserveScroll: true,
...
function UsersIndex() {
  ...
  return /* @__PURE__ */ jsx(AppLayout, { title: "Usuarios", active: "users", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6 p-10 pr-12", children: [
    /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-[28px] font-semibold text-foreground", children: "Usuarios" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Gestiona los usuarios del sistema" })
    ] }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-card rounded-xl border border-border overflow-hidden", children: [
      ...
      users.data.length === 0 && /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center justify-center py-12", children: /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: searchQuery ? "No se encontraron usuarios que coincidan con la búsqueda" : "No hay usuarios registrados" }) }),
